...
{
    int num = size * size;
    std::ofstream Data1("C:\\Users\\matro\\source\\repos\\Паралельная прога лаба1\\Lab3\\Data1.txt");
    for (size_t i = 0; i < num; i++) Data1 << rand() % 100 << "\t";
    std::ofstream Data2("C:\\Users\\matro\\source\\repos\\Паралельная прога лаба1\\Lab3\\Data2.txt");
